...
const AmbulanceRegistryPage = lazy(
  () => import('@pages/Admin/AmbulanceRegistryPage'),
);
const UserManagementPage = lazy(() => import('@pages/Admin/UserManagementPage'));
const HospitalRegistryPage = lazy(
  () => import('@pages/Admin/HospitalRegistryPage'),
);
const AlertRulesPage = lazy(() => import('@pages/Admin/AlertRulesPage'));
const StagingStationPage = lazy(() => import('@pages/Admin/StagingStationPage'));
...
export const ROUTES = {
  ...
  // Admin
  ADMIN: '/admin',
  ADMIN_AMBULANCES: '/admin/ambulances',
        ...
        <Route element={<ProtectedRoute />}>
          ...
          <Route element={<AppShell />}>
            ...
            <Route element={<ProtectedRoute allowedRoles={['ADMIN']} />}>
              ...
              <Route path={ROUTES.ADMIN_AMBULANCES} element={<AmbulanceRegistryPage />} />
              <Route path={ROUTES.ADMIN_USERS} element={<UserManagementPage />} />
              <Route path={ROUTES.ADMIN_HOSPITALS} element={<HospitalRegistryPage />} />
              <Route path={ROUTES.ADMIN_ALERTS} element={<AlertRulesPage />} />
              <Route path={ROUTES.ADMIN_STATIONS} element={<StagingStationPage />} />
            </Route>
          </Route>
        </Route>
