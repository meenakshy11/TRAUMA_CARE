...
# Read with utf-16 (PowerShell git redirect encoding)
orig = pathlib.Path('apps/web/src/pages/Hospitals/HospitalDetailPage_original.tsx').read_text(encoding='utf-16')
